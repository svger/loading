...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component__ = __webpack_require__(29);




__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__component__["a" /* default */], null), document.querySelector('#content'));
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(true){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(2);var warning=__webpack_require__(3);var ExecutionEnvironment=__webpack_require__(17);var _assign=__webpack_require__(4);var emptyFunction$1=__webpack_require__(1);var EventListener=__webpack_require__(18);var getActiveElement=__webpack_require__(19);var shallowEqual=__webpack_require__(20);var containsNode=__webpack_require__(21);var focusNode=__webpack_require__(24);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(5);var hyphenateStyleName=__webpack_require__(25);var camelizeStyleName=__webpack_require__(27);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_index__ = __webpack_require__(30);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.handleCallback = function () {
      alert('我是回调函数');
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      __WEBPACK_IMPORTED_MODULE_1__src_index__["a" /* default */].open({
        content: "加载中",
        iconType: "loading",
        delay: 2000,
        mask: false
      ...
      setTimeout(function () {
        __WEBPACK_IMPORTED_MODULE_1__src_index__["a" /* default */].close();
        console.log('我关闭了');
      }, 4000);
    }
  }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_cefc_ui_icon__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_index_less__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__style_index_less__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var createLoadingContainer = function createLoadingContainer(options) {
  ...
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Loading, options), loadingContainer);
};
...
var close = function close() {
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Loading, { isShow: false }), loadingContainer);
};
...
var LoadingContainer = function (_Component) {
  ...
  _createClass(LoadingContainer, [{
    ...
    value: function render() {
      ...
      var container = __WEBPACK_IMPORTED_MODULE_3_classnames___default()(prefixCls, className, _defineProperty({}, prefixCls + '-hiding', !isShow));

      var iconCls = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classnames2 = {}, _defineProperty(_classnames2, prefixCls + '-icon', true), _defineProperty(_classnames2, prefixCls + '-loading-icon', true), _classnames2));

      var loadingCls = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classnames3 = {}, _defineProperty(_classnames3, prefixCls + '-loading', true), _defineProperty(_classnames3, prefixCls + '-transparent', !mask), _classnames3));
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_cefc_ui_icon__["a" /* default */], { type: iconType, className: iconCls }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'span',
            null,
            content
...
LoadingContainer.propTypes = {
  className: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.oneOfType([//外部传入类
  __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string, __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object]),
  delay: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number, //延迟显示加载效果的时间（防止闪烁）
  iconType: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  prefixCls: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string, //自定义类
  content: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired, //loading的内容展示
  isShow: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool, //是否显示Loading
  onCallback: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func //loading隐藏后的回调处理函数
};
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      var classString = __WEBPACK_IMPORTED_MODULE_1_classnames___default()((_classnames = {
        'iconfont': true
      }, _defineProperty(_classnames, 'cefc-icon-' + type, true), _defineProperty(_classnames, 'cefc-icon-blue', color === 'blue'), _defineProperty(_classnames, 'cefc-icon-white', color === 'white'), _defineProperty(_classnames, 'cefc-icon-sm', size === 'sm'), _defineProperty(_classnames, 'cefc-icon-md', size === 'md'), _defineProperty(_classnames, 'cefc-icon-lg', size === 'lg'), _classnames), className);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--2-1!../../../postcss-loader/index.js??ref--2-2!../../../less-loader/index.js??ref--2-3!./index.less", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--2-1!../../../postcss-loader/index.js??ref--2-2!../../../less-loader/index.js??ref--2-3!./index.less");
...
// module
exports.push([module.i, ".cefc-icon-blue{color:#45a6ec}.cefc-icon-white{color:#fff}.cefc-icon-sm{font-size:.28rem}.cefc-icon-md{font-size:.3rem}.cefc-icon-lg{font-size:.32rem}", ""]);
...
// module
exports.push([module.i, ".cefc-loading{position:absolute;top:0;width:100%;height:100%;display:flex;justify-content:center;align-items:center}.cefc-loading-hiding{display:none}.cefc-loading-loading{display:flex;justify-content:center;align-items:center;flex-direction:column;background-color:#000;border-radius:.05rem;padding:.15rem .4rem;box-sizing:border-box;opacity:.7;z-index:5;max-width:80%}.cefc-loading-loading>span{text-align:center;font-size:.16rem;color:#fff;padding-bottom:.15rem}.cefc-loading-loading:before{content:\"\";position:absolute;top:0;width:100%;height:100%;background-color:#000;opacity:.5;z-index:4}.cefc-loading-loading.cefc-loading-transparent:before{background-color:#fff;opacity:0}.cefc-loading-icon{padding:.15rem 0;color:#fff;font-size:.27rem}.cefc-loading-icon.cefc-loading-loading-icon{-webkit-animation:spin 3s linear infinite;animation:spin 3s linear infinite}@keyframes spin{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}", ""]);
